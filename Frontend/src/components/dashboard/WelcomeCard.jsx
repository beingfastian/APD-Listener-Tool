      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
        <div className="bg-white rounded-lg p-3 sm:p-4 flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="text-xs sm:text-sm text-gray-600">Audio Held</div>
          </div>
          <div className="text-xs sm:text-sm font-medium text-gray-500">1%</div>
        </div>
        ...
        <div className="bg-white rounded-lg p-3 sm:p-4 flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="text-xs sm:text-sm text-gray-600">Chunks Ready</div>
          </div>
          <div className="text-xs sm:text-sm font-medium text-gray-500">+12%</div>
        </div>
      </div>
    </div>
  );
